...
def parse_args() -> argparse.Namespace:
    ...
    basemap.add_argument("--xyz-provider", default=None, choices=["eox_s2cloudless_2024", "openaerialmap"], help="Built-in free/open XYZ imagery provider preset.")
    ...
    basemap.add_argument("--xyz-extension", default=None, help="Downloaded tile extension. Defaults to the provider extension.")
